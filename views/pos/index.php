...
// var_dump($produits->getLibelle());die;
 ?>
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <div id="view-pos" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start; margin-bottom: 32px;">
                ...
                <div class="panel-card" style="margin-bottom: 0; padding: 24px; border: 1px solid rgba(59, 130, 246, 0.2); background: linear-gradient(180deg, rgba(17, 24, 43, 0.5) 0%, rgba(10, 15, 30, 0.3) 100%); position: sticky; top: 24px;">
                    ...
                    <form method="POST" action="/vente" id="order-creation-form">
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                              ...
                              <option value="6" data-limit="300000">
                                           SElectionner un client</option>
                                                            <?php foreach ($clients as $client): ?>
                                             <option value="<?= $client->getId() ?>" data-price="<?= $client->getPrixVente() ?>">
                        ...
                        <div style="border-top: 1px dashed var(--border-color); padding-top: 16px; margin-top: 16px; margin-bottom: 16px;">
                                 ...
                                 <option value="0">choisir un produit</option>
                                         <?php foreach ($produits as $produit): ?>
                                             <option value="<?= $produit->getId() ?>" data-price="<?= $produit->getPrixVente() ?>">
                                                 <?= $produit->getLibelle() ?> (Stock: <?= $produit->getStock() ?>)
                                             </option>
                                         <?php endforeach ?>
                                                                            </select>
                                </div>
                            ...
                            <div class="keypad-container" id="pos-keypad" style="max-width: 100%;">
                                ...
                                <button type="submit" name="Vente" value="saveSession"  class="keypad-btn" style="color: var(--success); font-size: 12px;">OK</button>
                            </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 24px;">
                             <div class="form-group" style="margin-bottom: 0;">
                                 ...
                                 <select name="mode_paiement_id" class="form-control" style="background-color: #0b0f1a; padding: 10px; font-size: 12px;">
                        ...
                        <button type="submit" name="Vente" value="saveVente" class="btn-submit btn-success" style="padding: 14px; font-weight: 800; font-size: 13px; width: 100%;">Valider la Vente (DML)</button>
                    </form>
                </div>
